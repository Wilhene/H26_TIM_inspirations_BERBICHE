...
<img src="./photo/vue_ensemble_symbiose.jpg" alt="Vue d'ensemble de l'oeuvre Symbiose" width=400>

> Installation finale de l'oeuvre de l'équipe Symbiose, *Symbiose*, 2026, présentée lors de l'exposition **RÉSEAU. 2026**. <br>
> Noms des créateurs et créatrices: **Yannick Chamberland**, **Benjamin Ferland**, **Ryan Dufault** et **Walid Cheour**.

### Schéma de l'installation prévue

<img src="./photo/schema_implementation_symbiose.jpg" alt="Schéma de l'implémentation de l'oeuvre Symbiose">
...
[![Capture d'écran du site de Deritative](./photo/technique_inconnu_symbiose.png)](https://derivative.ca/) 
...
<img src="./photo/schema_implementation_ocean_rouge.jpg" alt="Schéma de l'implémentation de l'oeuvre Océean rouge">
...
[![Capture d'écran du site de PureData](./photo/technique_inconnu_ocean_rouge.png)](https://puredata.info/)
...
<img src="./photo/vue_ensemble_oignon.jpg" alt="Vue d'ensemble de l'oeuvre Mission Décollage" width=400>

> Installation finale de l'oeuvre de l'équipe Mission décollage, *Mission décollage*, 2026, présentée lors de l'exposition **RÉSEAU. 2026**. <br>
> Noms des créateurs et créatrices: **Ahmed Kaissoumi**, **Radhouane Kordan**, **Justin Montpetit**, **Thearylou Lach** et **Jad Saloumi**.

### Schéma de l'installation prévue

<img src="./photo/schema_implementation_oignon.jpg" alt="Schéma de l'implémentation de l'oeuvre Mission Décollage">
...
[![Capture d'écran du site de PureData](./photo/technique_inconnu_oignon.png)](https://docs.arduino.cc/arduino-cloud/guides/arduino-c/)
...
<img src="./photo/vue_ensemble_arbre.jpg" alt="Vue d'ensemble de l'oeuvre Arbre en face" width=400>

> Installation finale de l'oeuvre de l'équipe Arbre en face, *Arbre en face*, 2026, présentée lors de l'exposition **RÉSEAU. 2026**. <br>
> Noms des créateurs et créatrices: **Alexandre Gendron**, **Mikael Arseneau**, **Mathieu Willett**, **Matis Ghariani** et **Rafael Angon Dube**.

### Schéma de l'installation prévue

<img src="./photo/schema_implementation_arbre.jpg" alt="Schéma de l'implémentation de l'oeuvre Arbre en face">
...
[![Capture d'écran du site de PureData](./photo/technique_inconnu_arbre.png)](https://surl.li/ttoreo)
...
<img src="./photo/schema_implementation_yeux.jpg" alt="Schéma de l'implémentation de l'oeuvre Quand les yeux se croisent">
...
[![Capture d'écran du site de PureData](./photo/technique_inconnu_yeux.png)](https://www.midjourney.com/home)
